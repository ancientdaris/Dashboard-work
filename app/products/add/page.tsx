    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 space-y-6 p-8 overflow-auto bg-gray-50">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold tracking-tight text-gray-900">Add New Product</h1>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="border-2 border-dashed rounded-lg p-8 bg-white/50 border-muted">
